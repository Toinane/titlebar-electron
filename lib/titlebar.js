...
class TitleBar extends EventEmitter {
  ...
  init() {
    ...
    if(this.options.fullscreen) this.titlebarElement.classList.add('fullscreen');
    ...
    if(this.options.backgroundColor) document.documentElement.style.setProperty('--background-color', this.options.backgroundColor);
    if(this.options.color) document.documentElement.style.setProperty('--color', this.options.color);
